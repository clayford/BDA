...
- 80% posterior intervals are provided by default in the `summary` output in the 10% and 90% columns
- You can use the `probs` argument to request different intervals. For example, to request a 95% interval for model "m": `summary(m, probs = c(0.025, 0.975))`
